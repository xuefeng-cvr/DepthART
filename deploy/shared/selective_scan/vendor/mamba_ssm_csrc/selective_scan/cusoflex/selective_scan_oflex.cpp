...
#define DEPTHART_BF16_DISPATCH(ITYPE, ...)                                          \
    else if (ITYPE == at::ScalarType::BFloat16) {                                  \
        using input_t = at::BFloat16;                                               \
        __VA_ARGS__();                                                              \
    }
#define DEPTHART_BF16_ALLOWED(ITYPE) || ITYPE == at::ScalarType::BFloat16
#else
#define DEPTHART_BF16_DISPATCH(ITYPE, ...)
#define DEPTHART_BF16_ALLOWED(ITYPE)
#endif
...
#define DISPATCH_ITYPE_FLOAT_AND_HALF_AND_BF16(ITYPE, NAME, ...)                    \
    if (ITYPE == at::ScalarType::Half) {                                            \
        ...
        __VA_ARGS__();                                                              \
    } DEPTHART_BF16_DISPATCH(ITYPE, __VA_ARGS__)                                    \
...
selective_scan_fwd(const at::Tensor &u, const at::Tensor &delta,
    ...
    TORCH_CHECK(input_type == at::ScalarType::Float || input_type == at::ScalarType::Half DEPTHART_BF16_ALLOWED(input_type));
